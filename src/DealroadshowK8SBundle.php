...
use Dealroadshow\Bundle\K8SBundle\DependencyInjection\Compiler\DisableReplicasPoliciesSubscriberPass;
use Dealroadshow\Bundle\K8SBundle\DependencyInjection\Compiler\DisableResourcesPoliciesSubscriberPass;
...
class DealroadshowK8SBundle extends Bundle
{
    public function build(ContainerBuilder $container): void
    {
        ...
        $container
            ...
            ->addCompilerPass(pass: new DisableReplicasPoliciesSubscriberPass())
            ->addCompilerPass(pass: new DisableResourcesPoliciesSubscriberPass())
        ;
    }
